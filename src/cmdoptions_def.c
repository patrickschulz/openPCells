...
cmdoptions_add_option(cmdoptions, NO_SHORT, "draw-anchors-sizehint", SINGLE_ARG, "size of added port labels for --draw-anchor and --draw-all-anchors");
...
cmdoptions_add_option(cmdoptions, NO_SHORT, "import", SINGLE_ARG, "generic import functionality, useful for importing digital gate-level verilog netlists and analog CDL netlists. This option expects a filename for a script which handles the import");
