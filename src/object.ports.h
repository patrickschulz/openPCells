...
void objectport_transform_to_global_coordinates(struct port* port, const struct transformationmatrix* matrix);
void objectport_transform_to_cell_coordinates(struct port* port, const struct transformationmatrix* matrix);
