...
struct transformationmatrix* transformationmatrix_chain_inv1(const struct transformationmatrix* m1, const struct transformationmatrix* m2);
struct transformationmatrix* transformationmatrix_copy(const struct transformationmatrix* old);
void transformationmatrix_invert_inline(struct transformationmatrix* target, const struct transformationmatrix* matrix);
