...
int export_writer_write_toplevel(struct export_writer* writer, const struct object* object, int expand_namecontext, int writechildrenports, char leftdelim, char rightdelim);
