return {
    ...
    pwell     = "UNUSED",
    deepnwell = { layer = { number = 64, name = "dnwell"    }, purpose = { number = 18 } },
    gate      = { layer = { number = 66, name = "poly"      }, purpose = { number = 20, name = "drawing" } },
    M1        = { layer = { number = 67, name = "li1"       }, purpose = { number = 20, name = "drawing" } },
    M2        = { layer = { number = 68, name = "met1"      }, purpose = { number = 20, name = "drawing" } },
    M3        = { layer = { number = 69, name = "met2"      }, purpose = { number = 20, name = "drawing" } },
    M4        = { layer = { number = 70, name = "met3"      }, purpose = { number = 20, name = "drawing" } },
    M5        = { layer = { number = 71, name = "met4"      }, purpose = { number = 20, name = "drawing" }, color = "blue", opacity = 1 },
    M6        = { layer = { number = 72, name = "met5"      }, purpose = { number = 20, name = "drawing" }, color = "red", opacity = 1 },
