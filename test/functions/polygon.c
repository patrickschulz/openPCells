...
int main(void)
{
    ...
    {
        struct simple_polygon* polygon = simple_polygon_create_from_rectangle(-50, -50, 50, 50);
        int intersect = simple_polygon_intersects_rectangle(polygon, 50, 50, 60, 60);
        check_boolean(!intersect, "polygon intersection 03");
        simple_polygon_destroy(polygon);
    }
    {
        struct simple_polygon* polygon = simple_polygon_create_from_rectangle(-50, -50, 50, 50);
        int intersect = simple_polygon_intersects_rectangle(polygon, 60, 60, 70, 70);
        check_boolean(!intersect, "polygon intersection 03");
        simple_polygon_destroy(polygon);
    }
}
