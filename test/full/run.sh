...
if [ $1 = "diff" ]; then
    ...
    ../../opc --show-gds-data test_$2.gds > ${testfile}
    ../../opc --show-gds-data reference_$2.gds > ${reffile}
    ...
    klayout test_$2.gds reference_$2.gds
elif [ $1 = "update" ]; then
    if [ ! $# -gt 1 ]; then
        echo "no test name given"
        exit 1
    ...
    do_cell_test mosfet_16 basic/mosfet gds
