...
function parameters()
    pcell.add_parameters(
        ...
        { "latchfingers", 6 },
        { "latchinterconnectwidth", technology.get_dimension("Minimum M1 Width") },
        { "outerdummies", 2 },
        { "invfingers", { 4, 8, 16 } },
        { "nmosclockfingerwidth", 1000 },
        { "pmosclockfingerwidth", 1000 },
        { "nmosinputfingerwidth", 1000 },
        { "pmosinputfingerwidth", 1000 },
        ...
        { "inputlinewidth", 500 },
        { "drainwidth", technology.get_dimension("Minimum M1 Width") },
        { "latchgatestrapwidth", technology.get_dimension("Minimum M1 Width") },
        { "latchgatestrapspace", technology.get_dimension("Minimum M1 Space") },
        { "inputgatewidth", technology.get_dimension("Minimum M1 Width") },
        { "inputdrainsourcespace", technology.get_dimension("Minimum M1 Space") },
        { "inputdrainsourcewidth", technology.get_dimension("Minimum M1 Width") },
        { "clockgatewidth", technology.get_dimension("Minimum M1 Width") },
        { "clockgatestrapxshift", 0 },
        { "clockgatestrapyshift", 0 },
        { "dummygatecontactwidth", technology.get_dimension("Minimum M1 Width") },
        { "invgatewidth", technology.get_dimension("Minimum M1 Width") },
        { "invgatestrapxshift", 0 },
        { "invgatestrapyshift", 0 },
        { "invdrainsourcespace", technology.get_dimension("Minimum M1 Space") },
        { "invdrainsourcewidth", technology.get_dimension("Minimum M1 Width") },
        { "drawQbuffer", false },
        { "nmosvthtype", 1 },
        { "pmosvthtype", 1 },
