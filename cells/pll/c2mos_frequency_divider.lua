        ...
        { -- first nmos row (clock)
            ...
            devices = {
                ...
                },
                {
                    ...
                    connectdrain = true,
                    connectdrainwidth = _P.drainwidth,
                    connectdrainspace = (_P.separation - _P.drainwidth) / 2,
                    drainmetal = 3,
                    drawtopgatecut = true,
                    drawbotgatecut = true,
                },
        ...
        { -- second nmos row (input)
            ...
            devices = {
                ...
                },
                {
                    ...
                    topgaterightextension = xpitch / 2,
                    connectsource = true,
                    connectsourcewidth = _P.drainwidth,
                    connectsourcespace = (_P.separation - _P.drainwidth) / 2,
                    sourcemetal = 3,
