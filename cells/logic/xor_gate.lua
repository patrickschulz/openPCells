...
function layout(gate, _P)
    ...
    gate:merge_into(geometry.rectangle(generics.via(1, 2, false), bp.glength, 2 * routingshift + bp.sdwidth)
        :translate(point.create(5 * xpitch / 2, 0)))
    --gate:merge_into(geometry.rectangle(generics.metal(1), bp.glength, bp.sdwidth)
    --    :translate(point.create(5 * xpitch / 2, -routingshift)))
