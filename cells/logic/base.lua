...
function parameters()
    pcell.add_parameters(
        ...
        { "pwidth(PMOS Finger Width)",                  tech.get_dimension("Minimum Gate Width") },
        { "nwidth(NMOS Finger Width)",                  tech.get_dimension("Minimum Gate Width") },
        { "sdwidth(Source/Drain Metal Width)",           tech.get_dimension("Minimum M1 Width") },
