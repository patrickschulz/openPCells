function parameters()
    pcell.add_parameters(
        ...
        { "usegatecut", false },
        { "pwidth", technology.get_dimension("Minimum MOSFET Fingerwidth") },
        { "nwidth", technology.get_dimension("Minimum MOSFET Fingerwidth") },
        { "drawstopgates", false },
        { "stopgatelength", technology.get_dimension("Minimum Gate Length"), follow = "gatelength" },
        { "bufferpwidth", technology.get_dimension("Minimum MOSFET Fingerwidth") },
        { "buffernwidth", technology.get_dimension("Minimum MOSFET Fingerwidth") },
