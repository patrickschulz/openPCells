function parameters()
    pcell.add_parameters(
        ...
        { "dummyfingers", 1 },
        { "bufferfingers", 8 },
        { "numrows", 4, posvals = even() },
        { "numdummyrows", 0 },
        { "inv_per_row", 5 },
        { "nand_row", 1 },
        { "gatelength", 10 * technology.get_dimension("Minimum Gate Length") },
        ...
        { "buffershift", 3000 },
        { "bufferouterpolylines", {} },
        { "bufferdrawstopgates", false },
...
function layout(toplevel, _P)
    ...
    local bufferref = pcell.create_layout("analog/inverter", "buffer", util.add_options(baseoptions, {
        ...
        drawleftstopgate = _P.bufferdrawstopgates,
        drawrightstopgate = _P.bufferdrawstopgates,
        leftpolylines = _P.bufferouterpolylines,
        rightpolylines = _P.bufferouterpolylines,
