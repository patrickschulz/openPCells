function parameters()
    pcell.add_parameters(
        ...
        { "sdwidth", technology.get_dimension_max("Minimum M1 Width", "Minimum Active Contact Target Width") },
        { "sdstrapwidth", technology.get_dimension("Minimum M2 Width") },
        { "sdstrapspace", technology.get_dimension("Minimum M1 Width") },
        { "gatestrapwidth", technology.get_dimension_max("Minimum M1 Width", "Minimum Gate Contact Target Width") },
