function parameters()
    pcell.add_parameters(
        ...
        { "fullnsourcedrainsize",                       technology.get_dimension("Minimum Gate Width"), follow = "pwidth" },
        { "fullpsourcedrainsize",                       technology.get_dimension("Minimum Gate Width"), follow = "pwidth" },
