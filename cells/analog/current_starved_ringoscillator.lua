...
function layout(oscillator, _P)
    ...
    oscillator:merge_into_shallow(vcoarray)
    ...
    oscillator:merge_into_shallow(cmarray)

    
    -- ** draw gate straps **
    -- * VCO *
    oscillator:merge_into_shallow(geometry.rectanglebltr(generics.metal(1), 
    ...
    oscillator:merge_into_shallow(geometry.rectanglebltr(generics.metal(2), 
    ...
    for i = 1, _P.numinv do
        ...
        oscillator:merge_into_shallow(geometry.path(generics.metal(1), geometry.path_points_xy(
