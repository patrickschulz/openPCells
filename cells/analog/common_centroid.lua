function parameters()
    pcell.add_parameters(
        ...
        { "fingers", 4 },
        { "viaoffset", 1000 },
        { "gatestrapwidth", technolog.get_dimension("Minimum M1 Width") },
        { "gatestrapspace", technolog.get_dimension("Minimum M1 Width") },
        { "gatestrapleftext", 0 },
        { "gatestraprightext", 0 },
        { "gatelinewidth", 100 },
        { "gatelinespace", 100 },
        ...
        { "gateconnwidth", technolog.get_dimension("Minimum M1 Width") },
