        ...
        for devnum, device in ipairs(row.devices) do
            if not device.skip or (_P.autoskip and device.fingers <= 0) then
                local status, mosfet = pcall(pcell.create_layout, "basic/mosfet", device.name, {
                    ...
                    vthtype = row.vthtype,
                    vthtypealignwithactive = not _P.splitgates or row.vthtypealignwithactive,
                    ...
                    topgatecutwidth = _select_parameter("topgatecutwidth", device, row),
                    ...
                    botgatecutwidth = _select_parameter("botgatecutwidth", device, row),
                    ...
                    extendoxidetop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendoxidetop", device, row), _P.separation / 2),
                    extendoxidebottom = _select_switch(((rownum == 1) or _P.splitgates), _select_parameter("extendoxidebottom", device, row), _P.separation / 2),
                    ...
                    extendvthtypetop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendvthtypetop", device, row), _P.separation / 2),
                    extendvthtypebottom = _select_switch(((rownum == 1) or _P.splitgates), _select_parameter("extendvthtypebottom", device, row), _P.separation / 2),
                    ...
                    extendimplanttop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendimplanttop", device, row), _P.separation / 2),
                    extendimplantbottom = _select_switch(((rownum == 1) or _P.splitgates), _select_parameter("extendimplantbottom", device, row), _P.separation / 2),
                    ...
                    extendwelltop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendwelltop", device, row), _P.separation / 2),
                    extendwellbottom = _select_switch(((rownum == 1) or _P.splitgates), _select_parameter("extendwellbottom", device, row), _P.separation / 2),
                    extendwellleft = _select_parameter("extendwellleft", device, row),
                    extendwellright = _select_parameter("extendwellright", device, row),
                    extendlvsmarkertop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendlvsmarkertop", device, row), _P.separation / 2),
                    extendlvsmarkerbottom = _select_switch(((rownum == 1) or _P.splitgates), _select_parameter("extendlvsmarkerbottom", device, row), _P.separation / 2),
                    ...
                    extendrotationmarkertop = _select_switch(((rownum == #_P.rows) or _P.splitgates), _select_parameter("extendrotationmarkertop", device, row), _P.separation / 2),
