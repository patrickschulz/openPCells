        ...
        for devnum, device in ipairs(row.devices) do
            if not device.skip then
                local status, mosfet = pcall(pcell.create_layout, "basic/mosfet", device.name, {
                    ...
                    extendallbottom = _select_switch(_P.splitgates, _select_parameter("extendallbottom", device, row), _P.separation / 2),
                    ...
                    extendoxidebottom = _select_switch(_P.splitgates, _select_parameter("extendoxidebottom", device, row), _P.separation / 2),
                    ...
                    extendvthtypetop = _select_switch(_P.splitgates, _select_parameter("extendvthtypetop", device, row), _P.separation / 2),
                    extendvthtypebottom = _select_switch(_P.splitgates, _select_parameter("extendvthtypebottom", device, row), _P.separation / 2),
                    ...
                    extendimplantbottom = _select_switch(_P.splitgates, _select_parameter("extendimplantbottom", device, row), _P.separation / 2),
                    ...
                    extendwellbottom = _select_switch(_P.splitgates, _select_parameter("extendwellbottom", device, row), _P.separation / 2),
                    ...
                    extendlvsmarkerbottom = _select_switch(_P.splitgates, _select_parameter("extendlvsmarkerbottom", device, row), _P.separation / 2),
                    ...
                    extendrotationmarkerbottom = _select_switch(_P.splitgates, _select_parameter("extendrotationmarkerbottom", device, row), _P.separation / 2),
