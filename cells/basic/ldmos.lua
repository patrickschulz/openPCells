function parameters()
    pcell.add_parameters(
        ...
        { "gatemetal",                      1 },
        { "sourcemetal",                    1 },
        { "sourcewidth",                    technology.get_dimension_max("Minimum M1 Width", "Minimum Source/Drain Contact Region Size") },
        { "sourcespace",                    technology.get_dimension("Minimum M1 Space") },
        { "sourceskip",                     0 },
        { "drainmetal",                     1 },
        { "drainwidth",                     technology.get_dimension_max("Minimum M1 Width", "Minimum Source/Drain Contact Region Size") },
        { "drainspace",                     technology.get_dimension("Minimum M1 Space") },
        { "gtopext",                        0 },
        { "gbotext",                        0 },
        ...
        { "guardringtopsep",                technology.get_dimension_max("Minimum Active Space", "Minimum M1 Space") },
        { "guardringbottomsep",             technology.get_dimension_max("Minimum Active Space", "Minimum M1 Space") },
        { "guardringleftsep",               technology.get_dimension_max("Minimum Active Space", "Minimum M1 Space") },
        { "guardringrightsep",              technology.get_dimension_max("Minimum Active Space", "Minimum M1 Space") },
