...
function layout(res, _P)
    -- poly strips
    res:merge_into_shallow(geometry.multiple_x(geometry.rectangle(generics.other("gate"), _P.width, _P.length + 2 * _P.extension + 2 * _P.contactheight), _P.nfingers + 2 * _P.dummies, _P.width + _P.space))
    -- contacts
