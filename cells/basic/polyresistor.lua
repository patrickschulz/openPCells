...
function layout(res, _P)
    ...
    -- contacts
    res:merge_into_shallow(geometry.multiple_xy(geometry.rectangle(generics.contact("gate"), _P.width, _P.contactheight), _P.nfingers, 2, _P.width + _P.space, _P.length + _P.extension + _P.contactheight))
    -- poly marker layer
