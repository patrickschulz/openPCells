function parameters()
    pcell.add_parameters(
        ...
        { "sourcesize(Source Size)",                                  tech.get_dimension("Minimum Gate Width"), "integer", follow = "fwidth" },
        { "drainsize(Drain Size)",                                    tech.get_dimension("Minimum Gate Width"), "integer", follow = "fwidth" },
