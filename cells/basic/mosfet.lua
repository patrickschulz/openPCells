function parameters()
    ...
    pcell.add_parameters(
        ...
        { "extendvthtypetop",                                                                           technology.get_dimension("Minimum Vthtype Extension"), follow = "extendalltop" },
        { "extendvthtypebottom",                                                                        technology.get_dimension("Minimum Vthtype Extension"), follow = "extendallbottom" },
        { "extendvthtypeleft",                                                                          technology.get_dimension("Minimum Vthtype Extension"), follow = "extendallleft" },
        { "extendvthtyperight",                                                                         technology.get_dimension("Minimum Vthtype Extension"), follow = "extendallright" },
