function parameters()
    ...
    pcell.add_parameters(
        ...
        { "guardringsep",                                                                               500 },
        { "guardringleftsep",                                                                           500, follow = "guardringsep" },
        { "guardringrightsep",                                                                          500, follow = "guardringsep" },
        { "guardringtopsep",                                                                            500, follow = "guardringsep" },
        { "guardringbottomsep",                                                                         500, follow = "guardringsep" },
