...
function layout(guardring, _P)
    ...
    guardring:merge_into(geometry.rectangle(generics.contact("active"), _P.width - _P.ringwidth, _P.ringwidth):translate(0,  _P.height / 2))
    guardring:merge_into(geometry.rectangle(generics.contact("active"), _P.width - _P.ringwidth, _P.ringwidth):translate(0, -_P.height / 2))
    guardring:merge_into(geometry.rectangle(generics.contact("active"), _P.ringwidth, _P.height - _P.ringwidth):translate(-_P.width / 2, 0))
    guardring:merge_into(geometry.rectangle(generics.contact("active"), _P.ringwidth, _P.height - _P.ringwidth):translate( _P.width / 2, 0))
