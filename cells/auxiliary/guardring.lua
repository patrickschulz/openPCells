function parameters()
    pcell.add_parameters(
        ...
        { "drawsoiopen",                                    true, },
        { "fillsoiopen",                                    false },
        { "soiopeninnerextension",                          technology.get_dimension("Minimum Soiopen Extension") , follow = "extendallinner" },
        { "soiopenouterextension",                          technology.get_dimension("Minimum Soiopen Extension") , follow = "extendallouter" },
