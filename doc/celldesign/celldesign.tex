...
\lstinputlisting{code/simple_rectangle.lua}
...
use parametrization.
\lstinputlisting[firstline = 2, lastline = 2]{code/simple_rectangle.lua}
In general, every cell will include this line at some point. Next we start the argument parsing:
\lstinputlisting[firstline = 4, lastline = 4]{code/simple_rectangle.lua}
...
\lstinputlisting[firstline = 5, lastline = 6]{code/simple_rectangle.lua}
...
\lstinputlisting[firstline = 7, lastline = 7]{code/simple_rectangle.lua}
This is optional, but good practice.

Now that we have all the layout parameters, we can finally create the rectangle:
\lstinputlisting[firstline = 10, lastline = 10]{code/simple_rectangle.lua}
...
\lstinputlisting[firstline = 13, lastline = 13]{code/simple_rectangle.lua}
And to write correct lua we finally close the function body:
\lstinputlisting[firstline = 14, lastline = 14]{code/simple_rectangle.lua}
...
\lstinputlisting[firstline = 4, lastline = 9]{code/rectangle_array.lua}
...
\lstinputlisting[firstline = 15, lastline = 22]{code/rectangle_array.lua}
...
\lstinputlisting[firstline = 12, lastline = 12]{code/rectangle_array.lua}
...
loop construct with:
\lstinputlisting[firstline = 25, lastline = 28]{code/rectangle_array.lua}
...
\lstinputlisting{code/rectangle_array.lua}
...
\lstinputlisting[firstline = 1, lastline = 11]{../cells/momcap.lua}
As before, we create the main object:
\lstinputlisting[firstline = 15, lastline = 15]{../cells/momcap.lua}
...
\lstinputlisting[firstline = 17, lastline = 25]{../cells/momcap.lua}
...
\lstinputlisting[firstline = 27, lastline = 33]{../cells/momcap.lua}
...
\lstinputlisting[firstline = 34, lastline = 39]{../cells/momcap.lua}
With this the pcell is finished, we only have to remember to return the created object and close the function:
\lstinputlisting[firstline = 41, lastline = 42]{../cells/momcap.lua}
...
\lstinputlisting[firstline = 30, lastline = 37]{../cells/octagonal_inductor.lua}
