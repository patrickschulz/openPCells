...
The object method for this is \luainline{merge_into_shallow}.
This method takes all shapes from a cell, copies them and places them in the cell that called \luainline{merge_into_shallow}.
...
\luafilelisting[widthgobble = 4, firstline = 4, lastline = 4]{code/merge_into_example.lua}
...
\luafilelisting[widthgobble = 4, firstline = 5, lastline = 5]{code/merge_into_example.lua}
As both \luainline{copy} and \luainline{flatten} are expensive functions, they are not the default.
This is why there is no \luainline{merge_into} or \luainline{merge_into_deep}.
