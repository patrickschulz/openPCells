...
\lualisting[widthgobble = 4, firstline = 12, lastline = 21]{code/rectangle_array.lua}
...
\lualisting[widthgobble = 4, firstline = 24, lastline = 28]{code/rectangle_array.lua}
...
\lualisting[firstline = 1, lastline = 12]{code/momcap.lua}
...
\lualisting[widthgobble = 4, firstline = 18, lastline = 31]{code/momcap.lua} 
...
\lualisting[widthgobble = 4, firstline = 33, lastline = 40]{code/momcap.lua}
...
\lualisting[widthgobble = 4, firstline = 42, lastline = 49]{code/momcap.lua}
...
\lualisting[firstline = 1, lastline = 11]{../../../cells/stdcells/not_gate.lua}
...
\lualisting[widthgobble = 4, firstline = 13, lastline = 13]{../../../cells/stdcells/1_inv_gate.lua}
...
\lualisting[widthgobble = 8, firstline = 62, lastline = 64]{../../../cells/stdcells/harness.lua}
...
\lualisting[widthgobble = 4, firstline = 75, lastline = 78]{../../../cells/stdcells/dff.lua}
...
\lualisting[widthgobble = 4, firstline = 14, lastline = 16]{../../../cells/stdcells/1_inv_gate.lua}
