...
To add a child, \luainline{add_child} is used, which expects a full object as reference and an instance name\footnote{This instance name is not
...
\begin{apifunc}{geometry.rectangle(layer, width, height, xshift, yshift, xrep, yrep, xpitch, ypitch)}
