...
OPCHEADERS:=lpoint.h lbind.h lload.h lbinary.h lstringbuffer.h lshape.h lunion.h lfilesystem.h
OPCCSOURCES:=ldir.c lpoint.c lbind.c lload.c lbinary.c lstringbuffer.c lshape.c lunion.c lfilesystem.c
